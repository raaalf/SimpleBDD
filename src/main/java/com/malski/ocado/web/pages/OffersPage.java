...
public class OffersPage extends WebPage implements OcadoPage, OcadoOffersPage {
    ...
    public OffersPage(ShopNavigator navigator, WebBrowser webBrowser) {
        super(webBrowser);
        shopNavigator = navigator;
        offersContainer = new OffersContainer(webBrowser, prodList);
    }

    @Override
    public void waitToLoad() {
        String appLocationXpath = "//div[@id='content']//ul[@id='breadcrumb']//*[text()='Offers']";
