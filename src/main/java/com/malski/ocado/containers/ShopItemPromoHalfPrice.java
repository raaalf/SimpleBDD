...
public class ShopItemPromoHalfPrice extends ShopItem {
    public final static String PROMO_MATCHER = "^Half Price, was £?(\\d+(\\.\\d{2})?)p?$";

    public ShopItemPromoHalfPrice(String id) {
        super(id);
    }
